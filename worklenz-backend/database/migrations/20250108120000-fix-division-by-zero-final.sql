-- Migration: Fix division by zero error in get_task_complete_ratio function
-- Date: 2025-01-08
-- Issue: Function crashes when calculating progress for tasks with 0 subtasks
-- Fix: Add IF check to prevent division by zero

BEGIN;

-- Update get_task_complete_ratio to handle zero subtasks gracefully
